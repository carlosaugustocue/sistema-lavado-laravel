...
@section('title', 'Nuevo Turno - Sistema de Lavado de Vehículos')

@section('content')
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Registrar Nuevo Turno</h1>
                ...
                <form action="{{ route('turnos.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="time" id="hora_inicio" name="hora_inicio" class="form-control @error('hora_inicio') is-invalid @enderror" value="{{ old('hora_inicio', '08:00') }}" required>
                            @error('hora_inicio')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="time" id="hora_fin" name="hora_fin" class="form-control @error('hora_fin') is-invalid @enderror" value="{{ old('hora_fin', '17:00') }}" required>
                            @error('hora_fin')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-1"></i> Registrar Turno
                        </button>
                    </div>
                </form>
            </div>
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p>Solo puede crear turnos para empleados activos.</p>
                <p>Asegúrese de que la hora de fin sea posterior a la hora de inicio.</p>
                <p>Los turnos se usarán para planificar la disponibilidad de los empleados.</p>
            </div>
        </div>
    </div>
</div>
