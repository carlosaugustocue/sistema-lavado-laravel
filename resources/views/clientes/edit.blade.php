...
@section('title', 'Editar Cliente - Sistema de Lavado de Vehículos')

@section('content')
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Editar Cliente</h1>
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{ route('clientes.show', $cliente->id) }}" class="btn btn-sm btn-outline-secondary">
                ...
                <form action="{{ route('clientes.update', $cliente->id) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="apellido" name="apellido" class="form-control @error('apellido') is-invalid @enderror" value="{{ old('apellido', $cliente->apellido) }}" required>
                            @error('apellido')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p>Cliente registrado desde: {{ $cliente->created_at->format('d/m/Y') }}</p>
                <p>Vehículos registrados: {{ $cliente->vehiculos->count() }}</p>
            </div>
        </div>
    </div>
</div>
